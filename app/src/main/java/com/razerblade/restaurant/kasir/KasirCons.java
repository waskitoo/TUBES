...
public class KasirCons implements Serializable {
...
public KasirCons(){}
    public KasirCons(String idMakanan, String jumlahMakanan, String harga, String meja, String statusBayar, String statusOrder) {
